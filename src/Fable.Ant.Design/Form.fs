...
module Form =
    ...
    type FormItemProps =
      ...
      | Extra of U2<string,Browser.Types.Node>
      ...
      | Help of U2<string,Browser.Types.Node>
      /// Label text
      | Label of U2<string,Browser.Types.Node>
      /// The layout of label.
    ...
    let inline formItem (props: IProp list) (children: ReactElement list): ReactElement =
    ...
    type FormProps =
      ...
      | OnSubmit of Browser.Types.Event
      interface Fable.React.Props.IProp

    let inline form (props: IProp list) (children: ReactElement list): ReactElement =
